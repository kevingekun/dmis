...
<body>
	...
	<div id="user-nav" class="navbar navbar-inverse">
		<ul class="nav">
		<li class=""><a title="首页" href="/knowledge/Doc/getRecentDoc"><i
					class="icon icon-home"></i> <span class="text"> 首页 </span></a></li>
			<li><a title="" href="/knowledge/Page/getPagepersonalCenter"><i
        ...
        <li><a class="sTrash" title="" href="#"><i class="icon-trash"></i> trash</a></li>-->
			...
			<li class=""><a title="登出" href="/knowledge/User/LoginOut"><i
